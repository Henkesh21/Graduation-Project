...
import 'package:healthy_lifestyle_app/ui/widgets/exercise_category_item.dart';
import 'package:provider/provider.dart';

class ExercisesCategoriesScreen extends StatefulWidget {
  static const routeName = '/exercises-categories';

  @override
  _ExercisesCategoriesScreenState createState() =>
      _ExercisesCategoriesScreenState();
}

class _ExercisesCategoriesScreenState extends State<ExercisesCategoriesScreen> {
  ...
  Future<bool> getModuleData() async {
    _moduleWithCondition =
        await _moduleService.fetchModulesWithCondition('name', 'exercises');
              ...
              builder: (context) => ConditionalBuilder(
                ...
                builder: (context) => StreamBuilder(
                    stream: categoryProvider
                        .fetchCategoriesAsStreamWithCondition('type', 'exercise'),
