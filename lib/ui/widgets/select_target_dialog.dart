...
class SelectTargetDialog extends StatefulWidget {
  ...
  @override
  _SelectTargetDialogState createState() => _SelectTargetDialogState();
}
                ...
                children: <Widget>[
                  ...
                  DateTimeFormField(
                    ...
                    validator: (DateTime dateTime) {
                      ...
                      //     dateTime.year > _endDate.year ||
                      //         dateTime.month > _endDate.month ||
                      //         dateTime.day > _endDate.day) {
                      //   return "Invalid Date";
                      // }
                      return null;
                    },
                  ...
                  DateTimeFormField(
                    ...
                    validator: (DateTime dateTime) {
                      ...
                      //     //     dateTime.month < DateTime.now().month ||
                      //     //     dateTime.day < DateTime.now().day ||
                      //     dateTime.year < _startDate.year ||
                      //         dateTime.month < _startDate.month ||
                      //         dateTime.day < _startDate.day) {
                      //   return "Invalid Date";
                      // }
                      return null;
                    },
